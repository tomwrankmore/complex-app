...
export default class Search {
  ...
  renderResultsHTML(posts) {//posts will be an array of results
    if(posts.length) {
  ...
  openOverlay() {
    ...
    setTimeout(() => this.inputField.focus() , 50)//delayed because div is hidden initially
  }
